								...
								<div class="navbar-collapse">	
									<div class="nav-inner">	
										<ul class="nav main-menu menu navbar-nav">
												...
												<li><a href="#" style="color:black !important;">Catégorie<i class="ti-angle-down"></i></a>
												<ul class="dropdown">
						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#telephone" role="tab">Téléphones</a></li>
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							...
							<h3>7th Genération <br> Promo <span>70%</span></h3>
				...
				<div class="col-lg-4 col-md-6 col-12">
					...
					<div class="shop-single-blog">
						...
						<div class="content">
							...
							<a href="#" class="title"> {{$prod->titre}}</a>
