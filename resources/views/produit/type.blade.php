					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li><a href="/">Categorie<i class="ti-arrow-right"></i></a></li>
						...
						<div class="shop-sidebar">
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										<li><a href="#">Alimentation & Boisson</a></li>
										<li><a href="#">Sport & Divertissement</a></li>
										<li><a href="#">Hygiene</a></li>
										<li><a href="#">Informatique & Technologique </a></li>
										<li><a href="#">Fourniture Bureaux</a></li>
										<li><a href="#">Electromenager</a></li>
										<li><a href="#">Cosmetique</a></li>
                                        <li><a href="#">Artisanat</a></li>
                                        <li><a href="#">Liminaire</a></li>
                                        <li><a href="#">Meubles</a></li>
                                        <li><a href="#">Animalerie</a></li>
                                        <li><a href="#">Bricolages</a></li>
                                        <li><a href="#">Jeux & Sport</a></li>
									</ul>
								</div>
								<!--/ End Single Widget -->
								<!-- Shop By Price -->
